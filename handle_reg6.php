...
<?php  // Script 6.7 - handle_reg5.php #6 /* This script recives seven values from register5.html */
...
if (is_numeric($_POST['year']) AND (strlen($_POST['year']) == 4) ) {
	...
	if ($_POST['year'] < 2016) {
		...
		print '<p class="error">Either you entered your birth year worng or you come from the future!</p>';
		$okay = false;
