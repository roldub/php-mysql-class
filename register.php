...
/* This page lets people register for thie site (in theory) */
...
print '<h2>Registration Form</h2>
	<p>Register so that you can take advantage of ceratin features like this, that, and the other thing</p>';
...
<?php include('templates/footer.html'); // Need footer ?>
